    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://valuelabs-4s.sentry.io/issues/?project=4509395388334160">Issues Page</a>.
